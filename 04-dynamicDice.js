...
The 'dynamicDice' function should return a 'NEW FUNCTION',
that accepts a number representing the total rolls you get multiplied by the sides of the dice
from the first function.

The returned function should return the maximum number you can get
...
const dynamicDice = sides => arg => sides*arg;
